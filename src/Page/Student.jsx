...
function Student() {
  ...
  const handleSubmit = (e) => {
    ...
    // API Calling
    {
      ...
      axios
        .post("http://localhost:8080/auth/students", added)
        .then((response) => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get("http://localhost:8080/auth/students")
      .then((res) => {
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-gray-700  overflow-hidden">
              <thead className="bg-gray-100">
                <tr>
                  <th className="px-6 py-2 text-sm font-semibold">Firstname</th>
              ...
              <tbody className="bg-white">
                {Filterdata.map((item, index) => (
                  ...
                  >
                    <td className="px-6 py-3 font-medium">{item.firstname}</td>
