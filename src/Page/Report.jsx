...
function Report() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8080/auth/entermarks")
      .then((res) => {
  ...
  return (
    <>
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-gray-800">Student Report</h2>
      ...
      {currentStudents.map((item, index) => {
        ...
        return (
          <div key={index} className="max-w-7xl mx-auto p-2 bg-white mb-4 ">
            {/* Student Info */}
